...
import { Page as MyPage, Text as PDFText, View as PDFView, Document as CustomDocument, StyleSheet, PDFViewer, Image, Font } from '@react-pdf/renderer';
                        ...
                        [1, 2, 3, 4].map(() => {
                            return (
                                <MyPage style={styles.body}>
                                    ...
                                    <PDFText style={styles.title}>Don Quijote de la Mancha</PDFText>
                                    <PDFText style={styles.author}>Miguel de Cervantes</PDFText>
                                    ...
                                    <PDFText style={styles.subtitle} break>
                                    ...
                                    <PDFText style={styles.pageNumber} render={({ pageNumber, subPageNumber, totalPages, subPageTotalPages }) => (
